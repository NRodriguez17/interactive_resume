class Extracurriculars
   ...
   def initialize(extracurricular1, dates1, description1, description2, extracurricular2, dates2, description3, description4, extracurricular3, dates3, description5, description6)
